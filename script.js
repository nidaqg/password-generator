...
//The function called to actually determine the password based on user chosen criteria
...
//if statement to check validity of password length input
  ...
  //for loop to add random characters from charOptions variable to finalPassword variable till choosen password lenght is reached
